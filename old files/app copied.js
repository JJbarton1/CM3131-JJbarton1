...
const characterTitle = document.getElementById("drink-name");
...
const characters = `https://api.punkapi.com/v2/beers/`;
...
function updateDisplay(jsonObj){ 
  ...
  let charImageURL = charObj.image_url;   //Get character image
...
function makeDetailsList(aCharObj){
  let characterPropertyList = ["name", "tagline", "abv", "description"];
